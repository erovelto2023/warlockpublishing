...
export default function IndustrialTemplate({ advertorial }: { advertorial: any }) {
    // Safe data access
                    ...
                    <div className="bg-white border-2 border-black p-8 md:p-10 shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] space-y-6">
                        ...
                        <div className="grid md:grid-cols-2 gap-8 pt-4">
                            ...
                            <div className="flex flex-col justify-center">
                                <a href={targetUrl} target="_blank" className="w-full bg-black text-white text-center py-5 text-sm font-black uppercase tracking-[0.2em] hover:bg-slate-800 transition-all flex items-center justify-center gap-3 shadow-lg">
                    ...
                    <section className="space-y-12">
                        ...
                        <div className="space-y-10">
                            <div className="bg-indigo-600 text-white p-10 shadow-xl">
                                ...
                                <p className="text-2xl md:text-3xl font-bold leading-tight">{valueProof.priceAnchoring}</p>
                            </div>
