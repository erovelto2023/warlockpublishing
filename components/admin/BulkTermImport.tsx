...
SCHEMA STRUCTURE:
{
  ...
  "useCases": "...",
  "whoUsesIt": "...",
  "targetAudience": { "primaryDemographic": "...", "readerPersonas": [], "painPoints": [], "desiredOutcomes": [] },
  "marketDemand": { "trendStatus": "...", "searchVolume": "...", "competitionLevel": "...", "monetizationPotential": "...", "averagePriceRange": "...", "marketSize": "..." },
  "howItMakesMoney": "...",
  "bestFor": "...",
  "commonMistakes": "...",
  "realExamples": "...",
  ...
  "productIdeas": [ { "type": "...", "title": "...", "description": "...", "format": "...", "estimatedLength": "...", "pricePoint": "..." } ],
  "competitorReferences": [ { "title": "...", "author": "...", "url": "...", "price": "...", "rating": "...", "reviewCount": "...", "type": "..." } ],
  "commonPitfalls": [ { "pitfall": "...", "whyItHappens": "...", "howToAvoid": "..." } ],
  "youtubeVideo": { "title": "...", "url": "...", "channel": "...", "views": "...", "duration": "...", "publishedDate": "...", "relevance": "..." },
  "videoUrl": "...",
  "blogArticle": { "title": "...", "slug": "...", "wordCount": "...", "content": "...", "metaTitle": "...", "metaDescription": "...", "focusKeyword": "...", "sources": [] },
  "marketingHooks": { "videoHooks": [], "blogTitles": [], "pinterestPinIdeas": [], "twitterTweetIdeas": [], "questionsAndAnswers": [ { "question": "...", "answer": "..." } ] },
  "headlines": [],
  "youtubeTitles": [],
  "pinterestIdeas": [],
  "instagramIdeas": [],
  "faqs": [ { "question": "...", "answer": "..." } ],
  "caseStudies": [ { "title": "...", "description": "...", "url": "..." } ],
  "relatedTermIds": [],
  "synonyms": [],
  "antonyms": [],
  "oppositeTerms": [],
  ...
  "affirmations": "...",
  "visualizations": "...",
  "audioOrVideoResources": "...",
  "whyItMatters": "...",
  "takeaways": [],
  "keyTakeaways": [],
  "gettingStartedChecklist": [],
  "aiPromptCommandCenter": { "productIdeaPrompt": "...", "contentStrategyPrompt": "...", "aiImagePrompt": "..." },
  "imagePrompt": "...",
  "productPrompt": "...",
  "socialPrompt": "...",
  "relatedKeywords": [ { "keyword": "...", "searchVolume": "...", "competitionLevel": "..." } ],
  "referenceWebsites": [ { "name": "...", "url": "..." } ],
