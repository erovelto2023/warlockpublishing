            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className="p-6 bg-white dark:bg-neutral-900 border border-neutral-200 dark:border-neutral-800 rounded-2xl">
                    <div className="flex items-center gap-3 mb-4">
                        ...
                        <h4 className="font-medium text-neutral-500">Total Page Views</h4>
                    </div>
                ...
                <div className="p-6 bg-white dark:bg-neutral-900 border border-neutral-200 dark:border-neutral-800 rounded-2xl">
                    <div className="flex items-center gap-3 mb-4">
                        ...
                        <h4 className="font-medium text-neutral-500">Peak Hour</h4>
                    </div>
                    <div className="text-3xl font-bold text-neutral-900 dark:text-white">
                ...
                <div className="p-6 bg-white dark:bg-neutral-900 border border-neutral-200 dark:border-neutral-800 rounded-2xl">
                    <div className="flex items-center gap-3 mb-4">
                        ...
                        <h4 className="font-medium text-neutral-500">Primary Source</h4>
                    </div>
                    <div className="text-3xl font-bold text-neutral-900 dark:text-white truncate">
                        ...
                        {popularPages.map((page, i) => (
                            <div key={page._id} className="group flex items-center justify-between p-3 hover:bg-neutral-50 dark:hover:bg-neutral-800/50 rounded-xl transition-colors">
                                <div className="flex items-center gap-4">
                                    ...
                                    <div>
                                        <div className="font-medium text-neutral-900 dark:text-white text-sm truncate max-w-[200px]">
                                            {page._id}
                                        </div>
                                ...
                                <div className="flex items-center gap-4">
                                    <div className="text-right">
                                        <div className="font-bold text-neutral-900 dark:text-white">{page.views}</div>
                                        <div className="text-[10px] uppercase font-bold text-neutral-400 tracking-wider">Views</div>
                                    </div>
                        ...
                        {topReferrers.map((ref) => (
                            <div key={ref._id} className="flex items-center justify-between p-3 border-b border-neutral-100 dark:border-neutral-800 last:border-0">
                                <div className="flex items-center gap-3">
                                    <div className={`w-2 h-2 rounded-full ${ref._id === 'Direct' ? 'bg-neutral-400' : 'bg-emerald-500'}`} />
